...
FLAGS = -std=c++11 -O3 -Xcompiler -fopenmp -arch=compute_60 -code=sm_60 -lcuda -lineinfo -I~/boost_1_72_0/boost -I~/boost_1_72_0/boost/sort -I~/boost_1_72_0/boost/sort/sample_sort

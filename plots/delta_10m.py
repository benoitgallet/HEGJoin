...
dimension = getColumn("delta_10m.txt", 0)
avg = getColumn("delta_10m.txt", 1)
min = getColumn("delta_10m.txt", 2)
max = getColumn("delta_10m.txt", 3)
...
plt.yticks(np.arange(0.0, 100.0, 5))
ax1.set_yscale("log")
...
plt.tight_layout()
print("Saving figure: delta_10m.pdf")
fig.savefig("delta_10m.pdf", bbox_inches='tight')

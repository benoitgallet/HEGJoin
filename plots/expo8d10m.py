...
epsilon = getColumn("expo8d10m_2.txt", 0)
gpu = getColumn("expo8d10m_2.txt", 1)
ego = getColumn("expo8d10m_2.txt", 3)
hybrid = getColumn("expo8d10m_2.txt", 2)
...
plt.tight_layout()
print("Saving figure: expo8d10m_2.pdf")
fig.savefig("expo8d10m_2.pdf", bbox_inches='tight')

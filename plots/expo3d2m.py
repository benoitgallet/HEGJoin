...
epsilon = getColumn("expo3d2m_2.txt", 0)
gpu = getColumn("expo3d2m_2.txt", 1)
ego = getColumn("expo3d2m_2.txt", 3)
hybrid = getColumn("expo3d2m_2.txt", 2)
...
plt.tight_layout()
print("Saving figure: expo3d2m_2.pdf")
fig.savefig("expo3d2m_2.pdf", bbox_inches='tight')

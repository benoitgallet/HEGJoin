...
epsilon = getColumn("expo6d2m_2.txt", 0)
gpu = getColumn("expo6d2m_2.txt", 1)
ego = getColumn("expo6d2m_2.txt", 3)
hybrid = getColumn("expo6d2m_2.txt", 2)
...
plt.tight_layout()
print("Saving figure: expo6d2m_2.pdf")
fig.savefig("expo6d2m_2.pdf", bbox_inches='tight')

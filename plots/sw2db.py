...
epsilon = getColumn("sw2db_2.txt", 0)
gpu = getColumn("sw2db_2.txt", 1)
ego = getColumn("sw2db_2.txt", 3)
hybrid = getColumn("sw2db_2.txt", 2)
...
plt.tight_layout()
print("Saving figure: sw2db_2.pdf")
fig.savefig("sw2db_2.pdf", bbox_inches='tight')

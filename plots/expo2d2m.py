...
epsilon = getColumn("expo2d2m_2.txt", 0)
gpu = getColumn("expo2d2m_2.txt", 1)
ego = getColumn("expo2d2m_2.txt", 3)
hybrid = getColumn("expo2d2m_2.txt", 2)
...
plt.tight_layout()
print("Saving figure: expo2d2m_2.pdf")
fig.savefig("expo2d2m_2.pdf", bbox_inches='tight')

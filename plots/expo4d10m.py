...
epsilon = getColumn("expo4d10m_2.txt", 0)
gpu = getColumn("expo4d10m_2.txt", 1)
ego = getColumn("expo4d10m_2.txt", 3)
hybrid = getColumn("expo4d10m_2.txt", 2)
...
ax1.set_xlabel(r'$\epsilon\;(\times10^{-3})$', fontsize=20)
ax1.set_ylabel('Time (s)', fontsize=18)

ax1.legend(fontsize=14, loc='upper left', fancybox=False, framealpha=1, handlelength=2, ncol=1)

plt.tight_layout()
print("Saving figure: expo4d10m_2.pdf")
fig.savefig("expo4d10m_2.pdf", bbox_inches='tight')

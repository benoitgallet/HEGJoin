...
echo
echo '## Epsilon 0.012'
./main $EXPO8D10M 0.012 8 0 | grep "RESULT"
./main $EXPO8D10M 0.012 8 0 | grep "RESULT"
./main $EXPO8D10M 0.012 8 0 | grep "RESULT"
...
echo
echo '## Epsilon 0.012'
./main $EXPO8D10M 0.012 8 1 | grep "RESULT"
./main $EXPO8D10M 0.012 8 1 | grep "RESULT"
./main $EXPO8D10M 0.012 8 1 | grep "RESULT"
...
echo '# Super-EGO'
echo '## Epsilon 0.0024'
./main $EXPO8D10M 0.0024 8 2 | grep "RESULT"
./main $EXPO8D10M 0.0024 8 2 | grep "RESULT"
./main $EXPO8D10M 0.0024 8 2 | grep "RESULT"
echo
echo '## Epsilon 0.0048'
./main $EXPO8D10M 0.0048 8 2 | grep "RESULT"
./main $EXPO8D10M 0.0048 8 2 | grep "RESULT"
./main $EXPO8D10M 0.0048 8 2 | grep "RESULT"
echo
echo '## Epsilon 0.0072'
./main $EXPO8D10M 0.0072 8 2 | grep "RESULT"
./main $EXPO8D10M 0.0072 8 2 | grep "RESULT"
./main $EXPO8D10M 0.0072 8 2 | grep "RESULT"
echo
echo '## Epsilon 0.0096'
./main $EXPO8D10M 0.0096 8 2 | grep "RESULT"
./main $EXPO8D10M 0.0096 8 2 | grep "RESULT"
./main $EXPO8D10M 0.0096 8 2 | grep "RESULT"
echo
echo '## Epsilon 0.012'
./main $EXPO8D10M 0.012 8 2 | grep "RESULT"
./main $EXPO8D10M 0.012 8 2 | grep "RESULT"
./main $EXPO8D10M 0.012 8 2 | grep "RESULT"

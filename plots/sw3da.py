...
epsilon = getColumn("sw3da_2.txt", 0)
gpu = getColumn("sw3da_2.txt", 1)
ego = getColumn("sw3da_2.txt", 3)
hybrid = getColumn("sw3da_2.txt", 2)
...
plt.tight_layout()
print("Saving figure: sw3da_2.pdf")
fig.savefig("sw3da_2.pdf", bbox_inches='tight')

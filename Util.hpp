...
public:
	...
	static void egoJoinV2(pPoint A, int frA, int toA, pPoint B, int frB, int toB, int start_dim, std::list<int> * result);
	...
	static void simpleJoin3(pPoint A, int frA, int toA, pPoint B, int frB, int toB, std::list<int> * result);
	...
	static void simpleJoin4(pPoint A, int frA, int toA, pPoint B, int frB, int toB, int m, std::list<int> * result);

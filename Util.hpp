...
public:
    ...
    static void egoJoinPreQueue(pPoint A, int frA, int toA, pPoint B, int frB, int toB, int start_dim, std::vector<unsigned int> * result, unsigned int * nbNeighbors);
    ...
    static void simpleJoinPreQueue(pPoint A, int frA, int toA, pPoint B, int frB, int toB, std::vector<unsigned int> * result, unsigned int * nbNeighbors);
    ...
    static void simpleJoinPreQueue2(pPoint A, int frA, int toA, pPoint B, int frB, int toB, int m, std::vector<unsigned int> * result, unsigned int * nbNeighbors);

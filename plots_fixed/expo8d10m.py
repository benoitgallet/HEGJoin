...
epsilon = getColumn("expo8d10m.txt", 0)
gpu = getColumn("expo8d10m.txt", 1)
ego = getColumn("expo8d10m.txt", 3)
hybrid = getColumn("expo8d10m.txt", 2)
...
plt.tight_layout()
print("Saving figure: expo8d10m.pdf")
fig.savefig("figures/expo8d10m.pdf", bbox_inches='tight')

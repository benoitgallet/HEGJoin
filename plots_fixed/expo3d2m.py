...
epsilon = getColumn("expo3d2m.txt", 0)
gpu = getColumn("expo3d2m.txt", 1)
ego = getColumn("expo3d2m.txt", 3)
hybrid = getColumn("expo3d2m.txt", 2)
...
plt.tight_layout()
print("Saving figure: expo3d2m.pdf")
fig.savefig("figures/expo3d2m.pdf", bbox_inches='tight')

...
epsilon = getColumn("expo2d2m.txt", 0)
gpu = getColumn("expo2d2m.txt", 1)
ego = getColumn("expo2d2m.txt", 3)
hybrid = getColumn("expo2d2m.txt", 2)
...
plt.tight_layout()
print("Saving figure: expo2d2m.pdf")
fig.savefig("figures/expo2d2m.pdf", bbox_inches='tight')

...
epsilon = getColumn("expo4d10m.txt", 0)
gpu = getColumn("expo4d10m.txt", 1)
ego = getColumn("expo4d10m.txt", 3)
hybrid = getColumn("expo4d10m.txt", 2)
...
plt.tight_layout()
print("Saving figure: expo4d10m.pdf")
fig.savefig("figures/expo4d10m.pdf", bbox_inches='tight')

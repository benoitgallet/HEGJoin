...
epsilon = getColumn("expo3d10m.txt", 0)
gpu = getColumn("expo3d10m.txt", 1)
ego = getColumn("expo3d10m.txt", 3)
hybrid = getColumn("expo3d10m.txt", 2)
...
plt.tight_layout()
print("Saving figure: expo3d10m.pdf")
fig.savefig("figures/expo3d10m.pdf", bbox_inches='tight')

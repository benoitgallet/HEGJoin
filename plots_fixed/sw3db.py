...
epsilon = getColumn("sw3db.txt", 0)
gpu = getColumn("sw3db.txt", 1)
ego = getColumn("sw3db.txt", 3)
hybrid = getColumn("sw3db.txt", 2)
...
plt.tight_layout()
print("Saving figure: sw3db.pdf")
fig.savefig("figures/sw3db.pdf", bbox_inches='tight')
